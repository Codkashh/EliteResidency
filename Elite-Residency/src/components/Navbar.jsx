...
const Navbar = () => {
  return (
    <div className='absolute top-0 left-0 width-full z-10'>
      <div className=' absolute mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent'>
        ...
        <ul className='hidden md:flex gap-7 text-white'>
            ...
            <a href="#Header" className='cursor-pointer hover:text-gray-700'>Testimonials</a>
        </ul>
